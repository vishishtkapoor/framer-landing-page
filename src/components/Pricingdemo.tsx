...
export const Pricing = () => {
  return (
    ...
    <div className="bg-black text-white  bg-gradient-to-b from-black via-[#409cff] to-black py-[72px] sm:py-24 ">

      <div className="container">
        <h2 className="text-center font-bold text-5xl sm:text-6xl tracking-tighter">Choose your IoT journey</h2>
